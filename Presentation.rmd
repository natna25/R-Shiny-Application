...
The SNCF dataset containing various information about trains : 
...
Let's determine the The average departure delay time of delayed trains
```{r, echo=FALSE}
...
The dashboard we have created thanks the different data that we have pre-processed
